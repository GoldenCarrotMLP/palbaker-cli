...
def create_cli_parser() -> argparse.ArgumentParser:
    ...
    mod_parser.add_argument("--key", help="Specific push setting key (materials, textures, animbp)")
    ...
    audio_set.add_argument("base_pal", help="Original base Pal")
    audio_set.add_argument("mod", help="Unique name of the mod")
    ...
    audio_clear.add_argument("base_pal", help="Original base Pal")
    audio_clear.add_argument("mod", help="Unique name of the mod")
    ...
    audio_play.add_argument("base_pal", help="Original base Pal")
    audio_play.add_argument("mod", help="Unique name of the mod")
    ...
    altermatic_toggle.add_argument("base_pal", help="Original base Pal")
    altermatic_toggle.add_argument("mod", help="Unique name of the mod")
    ...
    altermatic_list.add_argument("base_pal", help="Original base Pal")
    altermatic_list.add_argument("mod", help="Unique name of the mod")

    altermatic_add = altermatic_subparsers.add_parser("add", help="Add Altermatic variant")
    altermatic_add.add_argument("base_pal", help="Original base Pal")
    altermatic_add.add_argument("mod", help="Unique name of the mod")
    ...
    altermatic_delete.add_argument("base_pal", help="Original base Pal")
    altermatic_delete.add_argument("mod", help="Unique name of the mod")
    ...
    altermatic_sidecar.add_argument("base_pal", help="Original base Pal")
    altermatic_sidecar.add_argument("mod", help="Unique name of the mod")
    ...
    altermatic_metadata.add_argument("base_pal", help="Original base Pal")
    altermatic_metadata.add_argument("mod", help="Unique name of the mod")

    altermatic_open_blend = altermatic_subparsers.add_parser("open-blend", help="Open a .blend file in Blender")
    altermatic_open_blend.add_argument("base_pal", help="Original base Pal")
    altermatic_open_blend.add_argument("mod", help="Unique name of the mod")
    ...
    creator_add.add_argument("--template", required=True, help="Parent template Pal ID to clone")
    ...
    # Append inside create_cli_parser():
    replacer_parser = subparsers.add_parser("set-vanilla-replacer")
    replacer_parser.add_argument("base_pal")
    replacer_parser.add_argument("variant_name")
