...
class AltermaticCloner:
    ...
    def _execute_clone_workflow(self, mod_data: dict, label_name: str, create_custom_mesh: bool, source_choice: str, base_blend_path: str, fmodel_altermatic_dir: str, sync: bool = False):
        current_char_id = mod_data["name"]
